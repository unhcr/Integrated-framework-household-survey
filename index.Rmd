 ...
 * Multiple <kbd>[R statistical analysis scripts](https://github.com/Edouard-Legoupil/koboloadeR)</kbd> to clean & analyse data, and then to generate automatically standard report  and to facilitate the creation of presentation slides and infographics.
