...
<div class="note">
 * A pre-organised <kbd>[Master list of baseline Indicators Library](https://docs.google.com/spreadsheets/d/1zGnaLXouP9vTfjqVvUVOSfzeSkvpd63f8Z-zvqGJtNU)</kbd> in order to leverage good practices and enforce core questions during design of the assessment form.
 ...
 * Multiple <kbd>[R statistical analysis scripts](https://github.com/unhcr/Integrated-framework-household-survey/code)</kbd> to clean & analyse data, and then to generate automatically standard report  and to facilitate the creation of presentation slides and infographics.
