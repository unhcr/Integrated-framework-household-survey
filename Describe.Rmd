...
The first phase of the analysis consist at description of the various variable.
 ...
 * Discrete: cars, floors, arms, 
 * Date/Time: DOB, TOD, flight time
 
Categoric:
 * Ordinal: education level, salary level
 * Nominal: gender, relationship status
 * String: name, description, 
 
Geographic/spatial
 * Point: Cities
 * Line: Road
 * Polygon: Country, Governorate, Disctirc
...
It is often useful to display statistical information on maps.


![](images/prop.png) Proportion symbol map are used for absolute values.

![](images/choro.png) Choropleth map are used to display proportion of ration.
