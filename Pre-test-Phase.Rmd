...
As a good practice, the entire questionnaire should be submitted to a number of procedures to ensure there are no questions likely to test anything but respondent real status or opinion.
...
As a general rule, one should aim to pretest a form with at least 5 to 10 respondents and 2 different interviewers. If the survey is more complex, as studied by (reasearcher](https://www.researchgate.net/publication/263815867_Sample_size_for_pre-tests_of_questionnaires), a sample of 30 respondents is recommended.
...
Look for places where they hesitate or make mistakes
